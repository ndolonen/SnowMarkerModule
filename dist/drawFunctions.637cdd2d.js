...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/drawFunctions.js":[function(require,module,exports) {
...
function addModify() {
  ...
  blackModify = new Modify({
    source: drawSource
  });
  redModify = new Modify({
    source: redObject.source
  });
  orangeModify = new Modify({
    source: orangeObject.source
  });
  yellowModify = new Modify({
    source: yellowObject.source
  });
  greenModify = new Modify({
    source: greenObject.source
  });
  blueModify = new Modify({
    source: blueObject.source
  });
  purpleModify = new Modify({
    source: purpleObject.source
  }); //add interractions
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/drawFunctions.js"], null)
//# sourceMappingURL=/drawFunctions.637cdd2d.js.map